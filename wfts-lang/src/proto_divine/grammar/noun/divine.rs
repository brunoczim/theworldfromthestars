...
impl Noun {
    pub fn table(&self, entry_id: &Id) -> table::Entries<DynComponent> {
        case_fgender_number_table(Gender::Divine, |case, number| {
...
pub fn noun_div_companion() -> Noun {
    use Sonorant::*;
    use Vowel::*;
    Noun { nom_sing: proto_div_word![J, Ae] }
}
